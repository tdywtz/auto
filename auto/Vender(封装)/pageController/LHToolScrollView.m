...
-(void)createButtons{
    ...
    //评价分布
    NSString *text = [_titles componentsJoinedByString:@""];
    CGFloat textWidth =  [text boundingRectWithSize:CGSizeMake(1000, 20) options:NSStringDrawingUsesLineFragmentOrigin attributes:@{NSFontAttributeName:[UIFont systemFontOfSize:17]} context:nil].size.width;
    CGFloat space = (self.lh_width - textWidth)/ (_titles.count + 1);
