...
-(void)createUI{
    ...
    attribute.yy_firstLineHeadIndent = 30;
    attribute.yy_paragraphSpacing = 20;
    attribute.yy_color = colorBlack;
    attribute.yy_font = [UIFont systemFontOfSize:15];
    attribute.yy_lineSpacing = 3;
