...
-(void)loadData{
    ...
    [HttpRequest GET:[URLFile url_delComTypeList] success:^(id responseObject) {
...
-(void)submitData{
    ...
    [HttpRequest POST:[URLFile url_cancelComplain] parameters:dict success:^(id responseObject) {
